...
class _UserProfileScreenState extends State<UserProfileScreen>
        ...
        child: ListView(
          ...
          children: [
            ...
            _section(colors, "Ilova haqida", [
              _tile(colors, icon: Icons.info_outline_rounded, iconColor: colors.textTertiary, title: "Ilova versiyasi", subtitle: "v3.1.0"),
              ...
              _tile(colors, icon: Icons.headset_mic_rounded, iconColor: colors.success, title: "Qo'llab-quvvatlash", subtitle: "+998 90 000 00 00"),
              _tile(colors, icon: Icons.star_rounded, iconColor: colors.gold, title: "Ilovani baholash", subtitle: "Do'kondan baholash", onTap: () {}),
            ]),
            ...
            const SizedBox(height: 12),
            Center(child: Text('Sartaroshxona v3.1.0', style: TextStyle(color: colors.textTertiary, fontSize: 12))),
            const SizedBox(height: 24),
          ],
        ),
      ),
  ...
  Widget _tile(AppColors colors, {required IconData icon, required String title, String? subtitle, Widget? trailing, VoidCallback? onTap, Color? iconColor}) {
    return ListTile(
      onTap: onTap,
