...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  Future<void> _handleRegister() async {
    ...
    // Sartarosh uchun manzil tekshiruvi
    if (widget.selectedRole == 'barber' && _pickedLocation == null) {
    ...
    if (result['status'] == 'success') {
      _showMsg("Muvaffaqiyatli ro'yxatdan o'tdingiz!", isError: false);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          isBarber ? "Sartarosh ro'yxatdan o'tishi" : "Mijoz ro'yxatdan o'tishi",
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  isBarber
                      ? "Sartarosh sifatida ro'yxatdan o'ting va mijozlarni qabul qiling"
                      : "Mijoz sifatida ro'yxatdan o'ting va sartaroshlarni toping",
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (_pickedLocation != null)
                                  ...
                                  Text(
                                    "Xaritadan joylashuvingizni belgilang",
                                    style: TextStyle(color: colors.textSecondary, fontSize: 12),
                                  ),
                              ],
                            ),
